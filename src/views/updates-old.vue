...
<p>This page will no longer be updated; it has been moved to the updates page.</p>
    <el-timeline>
      <el-timeline-item timestamp="2026/01/03 3.4.0 to 3.4.1" placement="top">
      <el-card>
        <p>Just a minor exterior change. Happy New Year 2026!</p>
        <h3>View old page:</h3>
        <el-link href="https://5a628ba3.867678.pages.dev/" target="_blank">View Now</el-link>
      </el-card>
      </el-timeline-item>
      ...
      <el-card>
        ...
        <h3>View old page:</h3>
        <el-link href="https://5861c08b.867678.pages.dev/" target="_blank">3.3.9 to 3.4.0</el-link>
      </el-card>
      </el-timeline-item>
      ...
      <el-card>
        ...
        <h3>View old page:</h3>
        <el-link href="https://3a7f8e9c.867678.pages.dev/" target="_blank">3.3.6 to 3.3.7</el-link>
      </el-card>
      </el-timeline-item>
      ...
      <el-card>
        ...
        <h3>View old page:</h3>
        <el-link href="https://ba1a675f.867678.pages.dev/" target="_blank">3.3.3 to 3.3.4</el-link>
      </el-card>
      </el-timeline-item>
      ...
      <el-card>
        ...
        <p>Add a 404 page.</p>
        <h3>View old page:</h3>
        <el-link href="https://586a1502.867678.pages.dev/" target="_blank">3.3.1 to 3.3.2</el-link>
      </el-card>
      </el-timeline-item>
      ...
      <el-card>
        ...
        <h3>View old page:</h3>
        <el-link href="https://3179447e.867678.pages.dev/" target="_blank">3.2.1 to 3.2.2</el-link>
      </el-card>
      </el-timeline-item>
      ...
      <el-card>
        ...
        <h3>View old page:</h3>
        <el-link href="https://852fbea6.867678.pages.dev/" target="_blank">3.1.8 to 3.1.9</el-link>
      </el-card>
      </el-timeline-item>
      ...
      <el-card>
        <p>The download page is finally available for downloading!</p>
        <h3>View old page:</h3>
        <el-link href="https://4cac83dd.867678.pages.dev/" target="_blank">3.1.5 to 3.1.6</el-link>
      </el-card>
      </el-timeline-item>
      ...
      <el-card>
        ...
        <h3>View old page:</h3>
        <el-link href="https://10b9e470.867678.pages.dev/" target="_blank">3.1.4 to 3.1.5</el-link>
      </el-card>
      </el-timeline-item>
     ...
     <el-timeline-item timestamp="2025/09/08 3.0.4 to 3.0.6" placement="top">
      <el-card>
        ...
        <p>Reshaped the donation function.</p>
        <p>Moved updates and fixes pages to /updates ; Moved projects files to /projects</p>
      ...
      <el-card>
        ...
        <el-link href="https://s.867678.xyz/n/fac.kra" target="_blank">Changed a high-definition avatar, download? I chose the simplest trigger method,</el-link>
        <el-link href="https://s.867678.xyz/n/fac5.kra" target="_blank">please guess it yourself.</el-link>
        ...
        <h3>View old page:</h3>
        <el-link href="https://f537eb87.867678.pages.dev/" target="_blank">v3.0.3 to 3.0.4</el-link>
      </el-card>
      </el-timeline-item>
       <el-timeline-item timestamp="2025/09/06 2.0.6 to 3.0.3" placement="top">
      <el-card>
